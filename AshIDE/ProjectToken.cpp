...
const char *const AshIDE::sKeywords[NUM_KEYWORDS] = {"TRUE", "FALSE", "DEFINEDEF", "FILEDEF", "FILENAME", "WINDOW", "LANGUAGE", "LANG_NONE", "LANG_LC3", "LANG_LC3B", "SOURCETYPE", "LC3_SOURCE", "LC3_HEADER", "LC3B_SOURCE", "LC3B_HEADER", "RESOURCE", "DEPENDENCY", "PRINT_TOKENS", "PRINT_AST", "PRINT_SYMBOLS", "OUTPUT_IMAGE", "OUTPUT_VHDL", "USE_OPTIMIZATIONS", "USE_OS", "OLD_LC3", "DIS_REG", "EXPANDED", "NOTEXPANDED", "EXCLUDE_FROM_BUILD", "HELP_LOCATION", "LC3_OS_LOCATION", "LC3B_OS_LOCATION"};
const char *const AshIDE::sOperators[NUM_OPERATORS] = {"{", "}", "="};
