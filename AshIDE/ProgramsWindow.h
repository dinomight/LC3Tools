...
namespace AshIDE
{
	class ProgramsWindow : public Fl_Double_Window
	{
	protected:
	...
	public:
		/**********************************************************************\
			...
			Constructs the Programs window.
	...
	//*** Window Management Functions ***//
		...
		\******/
		static void CloseCB(Fl_Widget *pW, void *pV)	{	((ProgramsWindow *)pV)->Close();	}
		bool Close();
	...
	//*** Programs Management Functions ***//
		static void SaveCB(Fl_Widget *pW, void *pV)	{	((ProgramsWindow *)pV)->pTextDisplay->Save();	}
		static void CopyCB(Fl_Widget *pW, void *pV)	{	((ProgramsWindow *)pV)->pTextDisplay->Copy();	}
		static void FindCB(Fl_Widget *pW, void *pV)	{	((ProgramsWindow *)pV)->pTextDisplay->Find();	}
		static void FindAgainCB(Fl_Widget *pW, void *pV)	{	((ProgramsWindow *)pV)->pTextDisplay->FindAgain();	}
	...
	//*** Style Management Functions ***//
		...
		static void UpdateStyleCB(int Pos, int nInserted, int nDeleted, int nRestyled, const char *pszDeleted, void *pV)
			{	((ProgramsWindow *)pV)->UpdateStyle(Pos, nInserted, nDeleted, nRestyled, pszDeleted);	}
